...
- [MrEhbr/go-fsm](https://github.com/MrEhbr/go-fsm) ([v1.0.0](https://github.com/MrEhbr/go-fsm/releases/tag/v1.0.0), 2 weeks ago) - command line tool that generates finite state machine for Go struct
...
<details>
  ...
  <li><a href="https://github.com/auxten/postgresql-parser">auxten/postgresql-parser</a> - Pure Golang PostgreSQL (SQL:2011, SQL:2008, SQL:2003, SQL:1999, and SQL-92 Standard) Parser (9 months ago)</li>
