...
- [MrEhbr/go-fsm](https://github.com/MrEhbr/go-fsm) ([v2.0.0](https://github.com/MrEhbr/go-fsm/releases/tag/v2.0.0), 6 days ago) - command line tool that generates finite state machine for Go struct
