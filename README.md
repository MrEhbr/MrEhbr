...
- [MrEhbr/go-fsm](https://github.com/MrEhbr/go-fsm) ([v2.0.2](https://github.com/MrEhbr/go-fsm/releases/tag/v2.0.2), 3 days ago) - command line tool that generates finite state machine for Go struct
